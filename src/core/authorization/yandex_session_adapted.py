...
class YandexSessionAdapted:
    """Адаптированная версия YandexSession для работы вне Home Assistant."""

    def __init__(self, x_token: str | None = None, cookie: str | None = None) -> None:
    ...
    async def async_refresh(self) -> None:
        ...
        try:
            ...
            # Вне Home Assistant просто пробрасываем исключение
            raise
        except AuthException:
            raise

        # Cookie обновлены автоматически в сессии
